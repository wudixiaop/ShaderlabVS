...
/**********Date Type**********/
/*****************************/
({white_space}|{symbol}){datatype}({white_space}+|\(|\))  {return (int)ShaderlabToken.DATATYPE;}
({white_space}|{symbol}){unityDataType}({white_space}+|\(|\))  {return (int)ShaderlabToken.DATATYPE;}
